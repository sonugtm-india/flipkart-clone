  ...
  return (
    <Dialog open={open} onClose={closeDialog} PaperProps={{sx:{maxWidth:'unset'}}}>
     ...
     <Image>
        ...
        { account===true? <><Typography variant="h5">Login</Typography><Typography style={{marginTop:20}}>Get access to your Orders, Wishlist and Recommendations</Typography>
                          </>
                           :
                 <>
      ...
      { account===true?
       ...
       <Wrapper>
        ...
        {error && <Error> Invalid username or password </Error>}
         ...
         <Text>By continue, you are agree to fliplart's terms of Use and Privacy Policy</Text>
         <LoginButton onClick={loginUser}>Login</LoginButton>
         <Typography style={{textAlign:'center'}}> OR </Typography>
         <RequestOtp> Request OTP</RequestOtp>
         <Text style={{textAlign:'center'}} onClick={()=>toggleAccount()}> New to Flipkart? Create an account</Text>
       </Wrapper>
         :
         <Wrapper>
